...
public class IntegerFragment extends Fragment{
     ...
     */
    public static IntegerFragment newInstance(Expression exp) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_integer, container, false);

        ArrayList<Button> buttons = new ArrayList<>();

        buttons.add(view.findViewById(R.id.button_0));
